...
Page({
  ...
  data: {
    ...
    Institutional_items: [//机构分组列表
      { name: '国家级文化产业示范园区', checked: false },
      { name: '国家级文化产业试验园区', checked: false },
      { name: '国家级文化产业示范基地（单位企业）', checked: false },
      { name: '国家级文化产业示范基地（集聚类）', checked: false },
      { name: '省级文化产业示范园区', checked: false },
      { name: '省级文化产业示范基地', checked: false }
    ],
    practitioners: '',// 从业人员数
    area: '',// 经营面积
    prize: '',// 获得国家级文化奖项数量
    patent: '',// 获得著作权、发明专利总数
    enterprise: '',// 辖区内单体企业数量
  ...
  submit: function () {
    ...
    qt.prize = this.data.prize
    qt.patent = this.data.patent
    qt.enterprise = this.data.enterprise
